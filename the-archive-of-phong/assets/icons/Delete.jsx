...
const Delete = ({color = 'black',strokeWidth=1.9, props}) => (
    <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={color} fill={"none"}>
        ...
        <Path d="M9.5 16.5L9.5 10.5" stroke={color} strokeWidth="1.5" strokeLinecap="round"></Path>
        <Path d="M14.5 16.5L14.5 10.5" stroke={color} strokeWidth="1.5" strokeLinecap="round"></Path>
    </Svg>
);
